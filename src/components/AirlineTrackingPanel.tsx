//const airlines = [
  //{ name: '020 LH Lufthansa', url: 'https://www.lufthansa-cargo.com/en/eservices/etracking' },
  //{ name: '157 QR Qatar Airways', url: 'https://www.qrcargo.com/s/track-your-shipment' },
    ...
    //<div className="mt-10 sm:fixed sm:top-24 sm:right-4 w-full sm:w-64 space-y-2 z-50">
      ...
      //{airlines.map((airline, idx) => (
        //<a
          ...
          //className="block bg-white border border-blue-300 text-blue-700 py-2 px-4 rounded-lg shadow hover:bg-blue-100 text-sm text-left"
        //>
          //{airline.name}
        //</a>
      //))}
